 ...
 ************************************************************************/
    ...
    cout << "The Server B is up and running using UDP on port " << SERVER_A_PORT << "." << endl;
...
//        cout << recvargv << endl;
        ...
        cout << "The Server B has received " << data_num_sever << " numbers." << endl;
...
//            cout << result_FINAL[0] << endl;
        ...
        cout << "The Server B has successfully finished the reduction " << recvargv << ": " << result_FINAL[0] << endl;
