 ...
 ************************************************************************/
    ...
    cout << "The Server C is up and running using UDP on port " << SERVER_A_PORT << "." << endl;
...
//        cout << recvargv << endl;
        ...
        cout << "The Server C has received " << data_num_sever << " numbers." << endl;
...
//            cout << result_FINAL[0] << endl;
        ...
        cout << "The Server C has successfully finished the reduction " << recvargv << ": " << result_FINAL[0] << endl;
